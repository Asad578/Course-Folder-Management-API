...
import "./InstCourseOutline.css"; // Use the same styles as assignments

export default function InstExamContent() {
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await fetch(`http://127.0.0.1:8000/api/exams/${examId}/upload/`, {
        method: "PUT",
        body: formData,
      });
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await fetch(`http://127.0.0.1:8000/api/exams/${examId}/delete/`, {
        method: "PUT",
